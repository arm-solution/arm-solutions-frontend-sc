...
import EditProduct from '../modals-forms/edit-product-modal/EditProduct';
...
const Card = (props) => {
  ...
  const handleEnditProduct = (product, event) => {
  ...
  return (
    <>
      ...
      <div className="card-container">
          ...
          <div className="card bg-light-subtle mt-1" key={row.id}>
            ...
            <div className="card-body">
              ...
              <div className="cta-section">
                ...
                <button href="#" className="btn btn-dark" onClick={(e) => handleEnditProduct(row, e)}>Edit</button>
        ...
        <EditProduct modalRef={modalRef} product={editProduct}/>
